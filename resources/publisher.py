...
class Publisher:
    ...
    def __init__(self, url, gatewayId, exchange, publish_interval):
...
def main():
    ...
    dir = os.path.dirname(args.log_path+"/publisher.log")
    mkdir_p(dir)

    logging.basicConfig(filename=args.log_path+"/publisher.log",level=logging.DEBUG,format=LOG_FORMAT, mode='a')
    ...
    publisher = Publisher(args.amqp_url+'/%2F?connection_attempts=10&heartbeat_interval=3600', args.gatewayId, args.exchange, args.publish_interval)
    publisher.run()
